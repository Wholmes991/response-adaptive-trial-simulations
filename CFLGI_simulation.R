#Function: CFLGIsimulation (and FLGIallocationprobability)
#Purpose: to simulate a clinical trial using the CFLGI design 
...
CFLGIsimulation <- function(K,J,b,fisherco,p,sims,prior,mc){
      ...
      for (i in 1:sims){
            ...
            for (j in 3:3){
                  ...
                  probcontrol <- 1/(K-1) #Different definition of K to Villar
